...
const playGame = async () => {
    ...
    const { guess } = await inquirer.prompt([
        {
            type: "number",
            name: "guess",
            message: chalk.cyan("I'm thinking of a number between 1 and 10. Guess what it is!"),
            validate: (input) => {
    ...
    if (guess === randomNum) {
        ...
        console.log(chalk.red(`Sorry, you guessed ${guess}. The correct number was ${randomNum}.`));
    }
